 ...
 */
public class CircleFrame extends android.support.v7.widget.AppCompatImageView {
    // 图片按下的画笔
    ...
    public CircleFrame(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        // 获取控件的属性值
        if (attrs != null) {
            TypedArray array = context.obtainStyledAttributes(attrs, R.styleable.CircleFrame);
            borderColor = array.getColor(R.styleable.CircleFrame_ml_border_color, borderColor);
            borderWidth = array.getDimensionPixelOffset(R.styleable.CircleFrame_ml_border_width, borderWidth);
            pressAlpha = array.getInteger(R.styleable.CircleFrame_ml_press_alpha, pressAlpha);
            pressColor = array.getColor(R.styleable.CircleFrame_ml_press_color, pressColor);
            radius = array.getDimensionPixelOffset(R.styleable.CircleFrame_ml_radius, radius);
            shapeType = array.getInteger(R.styleable.CircleFrame_ml_shape_type, shapeType);
            array.recycle();
        }
